<?php
echo form_open_multipart('planilla_coordinadores/main/guardar', array('name' => 'guardar', 'class' => 'form-horizontal', 'novalidate' => 'novalidate'));
?>



<div id="add-coordinador2" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
